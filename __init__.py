...
class RiskDecision:
    allowed: bool
    reason: str
    adjusted_qty: float | None = None  # non-None means qty was scaled down
...
class RiskManager:
    def __init__(
        ...
        *,
        ...
        # Mutable state — updated as trades open/close
    ...
    def check(
        ...
        # Single-position risk — scale down if needed rather than reject
